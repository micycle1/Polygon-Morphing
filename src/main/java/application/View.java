...
public class View extends JScrollPane {
  ...
  public View(boolean small) {
    ...
    this.small = small;
    if (small) {
      setPreferredSize(new Dimension(338, 258));
      getViewport().setView(new DrawingPanel(320, 240));
    } else {
      setPreferredSize(new Dimension(658, 498));
      getViewport().setView(new DrawingPanel(640, 480));
    } 
  }
