...
import micycle.polygonmorphing.controls.AnimationSliderListener;
import micycle.polygonmorphing.controls.ClearButtonListener;
import micycle.polygonmorphing.featurePointDetection.FeaturePointDetector;
...
public class ExtendedController extends Controller {
	...
	public void update(Observable sender, Object arg) {
		...
		if (class_2 == null) {
			class_2 = class$0 = micycle.polygonmorphing.application.RadioButtonPanel.class;
		}
		...
		if (class_4 == null) {
			class_4 = class$1 = micycle.polygonmorphing.application.Model.class;
		}
	...
	public void stopAnimator() {
		this.ad = null;
		this.ad = !this.frames ? new AnimationDisplay(this.getMorphs(), this.getModel(), this)
				: new AnimationDisplay(this.getMorphs(), this.getModel(), this, this.fps);
	...
	public String toSVG() {
		...
		buff.append(
				"<animate begin=\"button.click\" dur=\"" + this.time * 2.0 + "s\" repeatCount=\"1\" fill=\"freeze\" attributeName=\"d\" ");
		buff.append("values=");
		...
		buff.append("<rect id=\"button\" x=\"" + width + "\" y=\"" + 10
	...
	protected class CalculateMorphButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			if (ExtendedController.this.changed) {
				...
				source.preparePolygon(ExtendedController.this.getSample_rate(), ExtendedController.this.getROS_size(),
						ExtendedController.this.isSimple_ROS());
				target.preparePolygon(ExtendedController.this.getSample_rate(), ExtendedController.this.getROS_size(),
						ExtendedController.this.isSimple_ROS());
				...
				if (!ExtendedController.this.frames) {
					...
					ExtendedController.this.ad = new AnimationDisplay(ExtendedController.this.getMorphs(),
							ExtendedController.this.getModel(), ExtendedController.this);
				} else {
					ExtendedController.this
							.setMorphs(Animator.animate(source, target, ExtendedController.this.fps, ExtendedController.this.time));
					ExtendedController.this.ad = new AnimationDisplay(ExtendedController.this.getMorphs(),
							ExtendedController.this.getModel(), ExtendedController.this, ExtendedController.this.fps);
				}
