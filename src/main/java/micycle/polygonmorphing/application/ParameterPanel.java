...
public class ParameterPanel extends JPanel {
	...
	private void createComponents() {
		...
		feature_var.setToolTipText(
				"Enter the denominator of the fraction, to change the weight for feature variation.\n Sum of all weights must be 1!");
		...
		feature_side.setToolTipText(
				"Enter the denominator of the fraction, to change the weight for side feature variation.\n Sum of all weights must be 1!");
		...
		feature_size.setToolTipText(
				"Enter the denominator of the fraction, to change the weight for feature size variation.\n Sum of all weights must be 1!");
